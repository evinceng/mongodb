...
if __name__ == "__main__":
    ...
    #pprint.pprint(rm[0])
    timeStamps = [sensor["timeStamp"] for sensor in rm]
    leftPupilDiameters = [sensor["leftPupilDiameter"] for sensor in rm]
    
    timeStampsnpArray = np.array(timeStamps)
    leftPupilDiametersnpArray = np.array(leftPupilDiameters)
